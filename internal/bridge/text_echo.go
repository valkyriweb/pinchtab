...
func fieldIsSensitive(ctx context.Context, selector string, nodeID int64) bool {
	...
	return staticfetch.IsSensitiveFieldAttrs(attrs.Type, attrs.Autocomplete, attrs.Name, attrs.ID, attrs.AriaLabel)
}
...
func readFieldAttrsByNodeID(ctx context.Context, nodeID int64) (*fieldAttrs, error) {
	...
	err := chromedp.Run(ctx, chromedp.ActionFunc(func(ctx context.Context) error {
		objectID, err := cdpops.IsolatedNodeObjectID(ctx, nodeID)
		if err != nil {
			return err
		}
